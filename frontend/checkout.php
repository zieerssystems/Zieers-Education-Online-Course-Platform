    ...
    <div class="billing-card card">
        ...
        <div class="card-body">
            <form class="checkout-form" id="checkoutForm">
                ...
                <div class="form-group" id="collegeNameGroup" style="display: none;">
                    <label for="collegeName">College Name</label>
                    <input type="text" id="collegeName" name="collegeName">
                </div>
                <div class="form-group" id="currentSemesterGroup" style="display: none;">
...
$(document).ready(function () {
    ...
    $('#userType').change(function() {
        ...
        $('#collegeNameGroup, #currentSemesterGroup, #professionGroup, #companyNameGroup').hide();

        if (userType === 'student') {
            $('#collegeNameGroup, #currentSemesterGroup').show();
        } else if (userType === 'professor') {
            $('#collegeNameGroup').show();
        } else if (userType === 'employee') {
            $('#professionGroup, #companyNameGroup').show();
        }
    });

    $('#placeOrderButton').click(function () {
        let requiredFields = $('#checkoutForm').find('[required]');
        let isValid = true;
