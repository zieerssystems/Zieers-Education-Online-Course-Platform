...
<div class="container">
    ...
    <?php if ($userDetails): ?>
        <div class="card">
            <h3>User Details</h3>
            <p><strong>Name:</strong> <?= htmlspecialchars($userDetails['firstName'] . ' ' . $userDetails['lastName']) ?></p>
    ...
    <div class="card">
        ...
        <?php foreach ($mergedData as $item): ?>
            <div class="product-item">
                ...
                <div class="product-price">₹<?= number_format($item['offer_price'] ?? 0, 2) ?></div>
            </div>
        <?php endforeach; ?>
