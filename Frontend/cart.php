...
<style>
    ...
    .add-course-btn {
        background-color: #1abc9c; /* New background color */
    }

    .add-course-btn:hover {
        background-color: #16a085; /* New hover color */
    }
...
$(document).ready(function () {
    ...
    function calculateTotal(items) {
        ...
        let gst = subtotal * 0.008; // 0.8% GST
    ...
    window.addCourseToCart = function () {
        // Redirect to the course selection page or open a modal to select a course
        window.location.href = 'courses.php'; // Replace with the actual URL of your course selection page
    };
});
</script>
