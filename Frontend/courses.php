        ...
        <div class="container">
            ...
            <div class="row course_boxes">
                <div class="course-container">
                    ...
                    <div id="courseCardsContainer" class="row"></div>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function () {
    ...
    // Load subjects from the backend
                ...
                <div class="col-md-4">
                    <div class="course-card">
                        ...
                        <div class="course-content">
                            ...
                            <button class="add-to-cart-btn" onclick="addToCart(${course.id}, '${course.course_name}')">Add to Cart</button>
                        </div>
                    </div>
                </div>
            `;
